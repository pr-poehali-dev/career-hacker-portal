...
const ABOUT_POINTS = [
  ...
  'Руководила автоматизацией подбора и HR-консалтингом для Mail.Ru, S8 Capital, GSK, Danone, ДОМ.РФ.',
...
const SERVICES = [
  ...
  { icon: 'Rocket', title: 'Сопровождение: хакнем наём за 1 месяц', desc: 'Полный путь от стратегии до оффера за месяц совместной работы.' },
